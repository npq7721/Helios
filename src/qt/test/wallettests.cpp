...
#include "qt/heliosamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<HeliosAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_helios-qt -platform xcb      # Linux
//     src/qt/test/test_helios-qt -platform windows  # Windows
//     src/qt/test/test_helios-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = HeliosUnits::formatWithUnit(unit, balance, false, HeliosUnits::separatorAlways);
    ...
    // Amount input
    HeliosAmountField* amountInput = receiveCoinsDialog.findChild<HeliosAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: helios:")) != -1);
