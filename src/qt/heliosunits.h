...
#ifndef helios_QT_heliosUNITS_H
#define helios_QT_heliosUNITS_H
...
/** Helios unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class HeliosUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit HeliosUnits(QObject *parent);

    /** Helios units.
      @note Source: https://en.helios.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        RVN,
...
typedef HeliosUnits::Unit HeliosUnit;

#endif // helios_QT_heliosUNITS_H
