...
// Copyright (c) 2009-2016 The Helios Core developers
...
static const HashGenesisBlockMap hashGenesisBlockMap = {
		{"main", "0x"},
		{"test", "0x"},
		{"regtest", "0x"}
};

static const HashMerkleRootkMap hashMerkleRootMap = {
		{"main", "0x"},
		{"test", "0x"},
		{"regtest", "0x"}
};

static const StartTimeMap startTimeMap = {
		{"main", 0},
		{"test", 0},
		{"regtest", 0}
};

static const  NounceMap nounceMap = {
		{"main", 0},
		{"test", 0},
		{"regtest", 0}
};
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("seed-testnet-helios.helioscoin.org", false); 
        vSeeds.emplace_back("seed-testnet-helios.bitactivate.com", false); 
