...
#ifndef helios_TEST_SCRIPTNUM10_H
#define helios_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Helios Core 0.10.0, for cross-comparison.
 */
public:
