...
By default, heliosd will dump mempool on shutdown and
...
class MempoolPersistTest(HeliosTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give heliosd a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent heliosd from writing mempool.dat to disk. Verify that `savemempool` fails")
