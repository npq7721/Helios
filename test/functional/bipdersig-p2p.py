...
class BIP66Test(HeliosTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # heliosd is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and heliosd produces more specific reject
            # reasons.
