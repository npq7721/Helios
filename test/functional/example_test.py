...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the HeliosTestFramework
    pass

class ExampleTest(HeliosTestFramework):
    # Each functional test is a subclass of the HeliosTestFramework class.
    ...
    def custom_method(self):
        ...
        HeliosTestFramework class so other tests can use it."""
