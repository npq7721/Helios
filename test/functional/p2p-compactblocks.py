...
# TestNode: A peer we use to send messages to heliosd, and store responses.
...
class CompactBlocksTest(HeliosTestFramework):
    ...
    # This test actually causes heliosd to (reasonably!) disconnect us, so do this last.
    ...
    # Test that heliosd requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for heliosd to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # heliosd will not send blocktxn responses for blocks whose height is
