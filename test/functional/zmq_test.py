...
from test_framework.test_framework import HeliosTestFramework, SkipTest
...
class ZMQTest (HeliosTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that helios has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("heliosd has not been built with zmq enabled.")
